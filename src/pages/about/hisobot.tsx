...
const Hisobot=()=>{
  return (
    ...
    <div className='w-[800px] h-auto '>
        <div>
          <h1 className=' text-[18px] text-[#222222] mt-5 text-center font-medium'>Toshkent metropolitenidan foydalanuvchi yo‘lovchilarning to‘lov tizimidan foydalanish</h1>
      ...
      <div className=' mt-[30px] w-[800px]'>
        ...
        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            <Progress type="circle" percent={59} strokeColor={twoColors} />
            <Progress type="circle" percent={23} strokeColor={twoColors} />
            <Progress type="circle" percent={10} strokeColor={conicColors} />
            <Progress type="circle" percent={5} strokeColor={twoColors} />
            <Progress type="circle" percent={3} strokeColor={twoColors} />
          </Flex>
        </div>
      ...
      <div className=' mt-[50px] w-[800px]'>
        <p className='mb-[-5px] text-[#3072ff] font-medium text-[26px]'>Fevral --------------------------------------------------------------------</p>

        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            <Progress type="circle" percent={53} strokeColor={twoColors} />
            <Progress type="circle" percent={23} strokeColor={twoColors} />
            <Progress type="circle" percent={12} strokeColor={conicColors} />
            <Progress type="circle" percent={10} strokeColor={twoColors} />
            <Progress type="circle" percent={2} strokeColor={twoColors} />
          </Flex>
        </div>
        <div className='w-[800px] h-auto flex justify-between mt-[40px] text-center'>
          <h1 className='w-[100px] h-[120px]  text-[24px] font-medium'>QR kodli chipta orqali</h1>
      ...
      <div className=' mt-[50px] w-[800px]'>
        ...
        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            ...
            <Progress type="circle" percent={23} strokeColor={twoColors} />
            <Progress type="circle" percent={12} strokeColor={conicColors} />
            <Progress type="circle" percent={11} strokeColor={twoColors} />
            <Progress type="circle" percent={2} strokeColor={twoColors} />
          </Flex>
        </div>
        <div className='w-[800px] h-auto flex justify-between mt-[40px] text-center'>
      ...
      <div className=' mt-[50px] w-[800px]'>
        ...
        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            ...
            <Progress type="circle" percent={23} strokeColor={twoColors} />
            <Progress type="circle" percent={12} strokeColor={conicColors} />
            <Progress type="circle" percent={13} strokeColor={twoColors} />
            <Progress type="circle" percent={2} strokeColor={twoColors} />
          </Flex>
        </div>
        <div className='w-[800px] h-auto flex justify-between mt-[40px] text-center'>
      ...
      <div className=' mt-[50px] w-[800px]'>
        ...
        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            <Progress type="circle" percent={53} strokeColor={twoColors} />
            <Progress type="circle" percent={21} strokeColor={twoColors} />
            <Progress type="circle" percent={13} strokeColor={conicColors} />
            <Progress type="circle" percent={10} strokeColor={twoColors} />
            <Progress type="circle" percent={2} strokeColor={twoColors} />
          </Flex>
        </div>
      ...
      <div className=' mt-[50px] w-[800px]'>
        ...
        <div className='w-[800px] h-auto'>
          <Flex gap="small" className='mt-[30px] flex justify-between'>
            <Progress type="circle" percent={56} strokeColor={twoColors} />
            <Progress type="circle" percent={20} strokeColor={twoColors} />
            <Progress type="circle" percent={13} strokeColor={conicColors} />
            <Progress type="circle" percent={9} strokeColor={twoColors} />
            <Progress type="circle" percent={2} strokeColor={twoColors} />
          </Flex>
        </div>
        <div className='w-[800px] h-auto flex justify-between mt-[40px] text-center'>
      ...
      <div className='w-[600px] h-auto mb-[50px] mt-[50px] ms-[100px]'>
        <h1 className=' text-[18px] text-[#222222] mt-5  font-medium'>Toshkent metropolitenidan foydalanuvchi yo‘lovchilarning 6 oy davomida to‘lov tizimidan foydalanish</h1>
