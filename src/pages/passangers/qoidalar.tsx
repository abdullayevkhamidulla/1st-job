...
const qoidalar = () => {
  return (
    ...
    <div className='w-[800px] h-auto '>
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>1. UMUMIY QOIDALAR</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>Ushbu qoidalar metrodan va metro ishchilaridan foydalanadigan barcha shaxslar uchun majburiydir.
          ...
          <div className='mt-4'>
            <h1 className='text-[18px]  text-[#686666] text-center font-medium'>2. METRO XODIMLARIDAN QUYIDAGILAR TALAB QILINADI</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>2.1. poezdlar harakati jadvali va yo’lovchilar xavfsizligini ta’minlash, ularga zarur qulayliklar yaratish va xizmat ko’rsatish madaniyatini ta’minlash, ogohlantirish;
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>3. YO‘LOVCHILAR BILISHLARI SHART</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>3.1. xavfsizlik xodimlari, politsiya va metro xodimlarining talablarini qat’iy bajarish, jamoat tartibiga, sanitariya talablariga va ushbu qoidalarga rioya qilish;
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>4. YO‘LOVCHILAR QUYIDAGI HUQUQLARGA EGA</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>4.1. 7 yoshgacha bo‘lgan bolalarni, shuningdek chang’i, bolalar velosipedlari, chanalar, qarmoqlar, musiqa asboblari, kichik bog’ asboblarini qopqoqli idishlarda bepul tashish;
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>5. METRODA TAQIQLANGAN</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>6. METRODA XAVFSIZLIK TALABLARI </h1>
            <p className='text-[#686666] leading-[30px] mt-4'>6.1. metro ishchilari va yo‘lovchilari hushyor va ehtiyotkor bo‘lishlari kerak;
          ...
          <div className='mt-4'>
            <h1 className='text-[18px] text-[#686666] text-center font-medium'>7. METRODA YO‘LOVCHILAR TASHISHI TAQIQLANGAN SUYUQLIK VA MODDALAR RO‘YXATI:</h1>
            <p className='text-[#686666] leading-[30px] mt-4'>7.1. tez yonuvchan suyuqliklar – benzin, kerosin, atseton, alkogol, barcha brendlarning erituvchilari;
