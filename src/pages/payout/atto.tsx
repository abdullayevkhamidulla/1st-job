...
const Atto: React.FC = () => (
  ...
  <div className='w-[100%] h-auto mt-[200px] flex justify-center'>
    ...
    <div className="w-[300px] h-auto gap-14  flex flex-col ">
          <div className="w-[300px] h-[100px] text-center bg-[#002D40]">
    ...
    <div className='w-[800px] h-auto  p-4 rounded-lg text-white'>
          <h1 className='text-[#648ce1] text-[30px] font-medium'>Kontaktsiz texnologiyali (NFC)</h1>
          <p>transport kartasi</p>
          <hr />
          <div className='mt-10'>
            <h1 className='text-[22px] font-medium'>ATTO transport kartasi nima?</h1>
            <p className='text-[#fff] mt-4'>“ATTO” transport kartasi Toshkent shahridagi jamoat transportida yo‘l haqini tez va qulay tarzda to‘lash imkonini beradi. Ayni paytda ular “Toshshahartrans” aksiyadorlik jamiyatining barcha avtobuslarida hamda “Toshkent metropoliteni”ning yer osti va yer usti bekatlar vestibyullarining barcha turniketlarida qabul qilinmoqda.</p>
          </div>
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>ATTO transport kartalari nima?</h1>
            <p className='text-[#fff] mt-4'>Hozirgi vaqtda ATTO transport kartalarining to‘rt turi joriy qilingan. Aholiga, ya’ni barcha turdagi yo‘lovchilarga mo‘ljallangan umumiy transport kartasi (ko‘k) va jamoat transportida imtiyozli sayohat qilish huquqiga ega bo‘lgan yo‘lovchilar uchun uchta turdagi transport kartalari – talabalar (yashil), talabalar (sariq), ijtimoiy nafaqaxo‘rlar va nogironlar uchun (qizil).</p>
          </div>
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>ATTO transport kartasini qayerdan sotib olsam bo‘ladi?</h1>
            <p className='text-[#fff] mt-4'>“ATTO” transport kartalari “Toshshahartransxizmat” AJning barcha chiptalarni sotish nuqtalarida, shuningdek, “Toshkent metropoliteni” DUKning barcha kassalarida sotiladi.</p>
          </div>
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>“ATTO” transport kartasi balansini qanday to‘ldirish mumkin?</h1>
            <p className='text-[#fff] mt-4'>“ATTO” transport kartasi balansini ATTO, MyUzcard, Payme, Upay, Apelsin toʻlov xizmatlari va boshqa elektron toʻlov tizimlarining mobil ilovalari orqali toʻldirish mumkin.
          ...
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>ATTO transport kartasi orqali yo‘l haqini qanday to‘lash kerak?</h1>
            <p className='text-[#fff] mt-4'>Avtobus yo‘l haqini to‘lash uchun siz ATTO transport kartasini tutqichga o‘rnatilgan statsionar validatorga yoki konduktordagi mobil validatorga biriktirishingiz kerak. ATTO operatori yo‘l haqini to‘lash uchun transport kartasini konduktorga bermaslikni tavsiya qiladi, chunki ular bir yo‘lovchining transport kartasini boshqa yo‘lovchining kartasi bilan chalkashtirib yuborishi mumkin.
          ...
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>Transport kartasidagi qoldiqni qanday aniqlash mumkin?</h1>
            <p className='text-[#fff] mt-4'>“ATTO” transport kartasi balansini ATTO, MyUzcard, Payme, Upay, Apelsin toʻlov xizmatlari va boshqa elektron toʻlov tizimlarining mobil ilovalari yordamida tekshirish mumkin.
            O‘z-o‘ziga xizmat ko‘rsatadigan bank terminallarida – infokiosklarda. To‘ldirish bo‘limida ATTO tizimiga ulangan bank o‘ziga xizmat ko‘rsatish terminallari-infokiosklarining joylashuvi to‘g‘risidagi ma‘lumotlar ko‘rsatilgan.
          ...
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>Transport kartasidagi balans 1700 so‘mdan kam bo’lsa nima bo‘ladi?</h1>
            <p className='text-[#fff] mt-4'>Agar ATTO transport kartasi qoldig‘i 1700 so‘mdan kam bo‘lsa, to‘lovsiz sayohat xavfini oldini olish maqsadida transport kartasi avtomatik ravishda vaqtincha bloklangan kartalar ro‘yxatiga qo‘shiladi.
          ...
          <div className='mt-8'>
            <h1 className='text-[22px] font-medium'>ATTO transport kartasini uchinchi shaxslarga berish mumkinmi?</h1>
            <p className='text-[#fff] mt-4'>Toshkent shahrida yoʻlovchilar oqimining toʻgʻri statistikasini shakllantirish va jamoat transportini optimallashtirish maqsadida ATTO transport katrasidan foydalanish faqat bitta yoʻlovchiga hisoblab chiqilgan.
