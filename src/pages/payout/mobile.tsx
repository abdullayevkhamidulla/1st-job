    ...
    <div className='w-[100%] h-auto mt-[200px] flex justify-center'>
      <div className='w-[80%] h-auto flex justify-evenly'>
        ...
        <div className="w-[600px] h-[600px] flex flex-col justify-end">
          <h1 className="text-[30px] font-medium">Telefoningiz platformasini tanlang</h1>
          ...
          <h1 className="text-[30px] font-medium mb-5">ATTO mobil ilovasini yuklab oling</h1>
          <div className="flex gap-3 items-center mb-3">
            <FaAngleRight className="w-[50px] h-[50px] text-[#4534ff] hover:text-[#f9e9e9]"/>
            <p className="text-[20px] text-[#898181]">Xarajatlaringizni nazorat qiling</p>
          </div>
          <div className="flex gap-3 items-center mb-3">
            <FaAngleRight className="w-[50px] h-[50px] text-[#4534ff] hover:text-[#f9e9e9]"/>
            <p className="text-[20px] text-[#898181]">Kartani onlayn tarzda to'ldiring</p>
          </div>
          <div className="flex gap-3 items-center mb-3">
            <FaAngleRight className="w-[50px] h-[50px] text-[#4534ff] hover:text-[#f9e9e9]"/>
            <p className="text-[20px] text-[#898181]">Yo'qolgan taqdirda kartani bloklang</p>
          </div>
          <div className="flex gap-3 items-center mb-3">
            <FaAngleRight className="w-[50px] h-[50px] text-[#4534ff] hover:text-[#f9e9e9]"/>
            <p className="text-[20px] text-[#898181]">Bepul virtual ATTO kartasini buyurtma qiling</p>
          </div>
        </div>
      </div>
    </div>
