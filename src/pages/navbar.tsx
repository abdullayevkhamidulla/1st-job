  ...
  return (
    ...
    <div className='w-100px h-[40px] flex pt-1 pb-1 text-[14px] justify-around bg-[#ffffff] border-[1px] border-black'>
        <div className='flex gap-4 items-center '>
          ...
          <path d="M9 16.5C4.85786 16.5 1.5 13.1421 1.5 9C1.5 4.85786 4.85786 1.5 9 1.5C13.1421 1.5 16.5 4.85786 16.5 9C16.5 13.1421 13.1421 16.5 9 16.5ZM9 15C12.3137 15 15 12.3137 15 9C15 5.68629 12.3137 3 9 3C5.68629 3 3 5.68629 3 9C3 12.3137 5.68629 15 9 15ZM9.75 9H12.75V10.5H8.25V5.25H9.75V9Z" fill="black"/>
          </svg>
    ...
    <div className='flex px-2 z-0 bg-[#2a9b9f]  absolute top-16 left-[220px] text-[16px] rounded-[28px] w-[1100px] h-[50px] items-center '>
      ...
      <ul className="nav-list flex text-[#fff] font-inter items-center gap-4 ">
                ...
                <div className="group inline-block text-[15px] relative">
                  <button className="text-white bg-[#2a9b9f] px-4 py-2 rounded-lg hover:bg-blue-600">Yo'lovchilar</button>
                  <div className="hidden group-hover:block absolute bg-[#2a9b9f] shadow-md py-2 rounded-lg mt-2 ">
                    <Link to={'/Murojatlar'}>
                ...
                <div className="group inline-block text-[15px] relative">
                  <button className="text-white bg-[#2a9b9f] px-4 py-2 rounded-lg hover:bg-blue-600">Pressa</button>
                  <div className="hidden group-hover:block absolute bg-[#2a9b9f] shadow-md py-2 rounded-lg mt-2 ">
                    <Link to={'/Yangiliklar'}>
