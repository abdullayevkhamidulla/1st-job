...
const Navbar:React.FC = () => {
  ...
  return (
    ...
    <div className='flex px-2 z-0 bg-[#16a39c] dark:bg-[#002D40] absolute top-16  text-[16px] border-[white] border-[1px] text-[white] rounded-[28px] w-[70%] h-[50px] items-center '>
