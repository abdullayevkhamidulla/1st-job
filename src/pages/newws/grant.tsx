...
const Grant = () => {
  return (
    ...
    <div className='w-[840px] h-auto flex flex-col gap-10'>
        ...
        <h1 className='text-[black] text-[21px]'>“Toshkent metropoliteni” DUK uchun 2 100 000 AQSh dollari ekvivalentida grant mablag‘lari ajratildi</h1>
        <p className='text-[gray]'>Noyabr 14, 2023By Metro22</p>
